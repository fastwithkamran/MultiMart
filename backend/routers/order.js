...
const { handleOrder, handleGetUserOrders, handleGetShopOrders, handleUpdateOrderStatus } = require("../controllers/order.js");
// create an order
...
router.put("/update-order-status/:id", handleUpdateOrderStatus)
